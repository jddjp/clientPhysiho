          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text("Enviamos un código a +52 " + widget.phoneData['phoneNumber']),
                ...
                press: () async {
                  if (_formKey.currentState.validate()) {
                    ...
                    Provider.of<LoginProvider>(context, listen: false)
                      .signInWithPhone(verificationId: verificationId, smsCode: smsCode)
                      .then((o) {
                        // Redirect
                        if ( ! Provider.of<LoginProvider>(context, listen: false).isCompleted()) {
