          ...
          child: SafeArea(
            child: Column(
              children: <Widget>[
                ...
                Divider(),
                ListTile(
                  onTap: () { launch("https://web.yerli.app/legal/privacidad"); },
                  title: text("Política de privacidad"),
                  trailing: Icon(Icons.keyboard_arrow_right),
                ),
                Divider(),
                ListTile(
                  onTap: () { launch("https://web.yerli.app/legal/terminos"); },
                ...
                text("Statika Digital", fontWeight: fontBold, fontSize: textSizeSMedium),
              ],
            )
          ),
        ),
