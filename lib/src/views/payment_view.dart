...
class _PaymentViewState extends State<PaymentView> {
  ...
  Map<String, dynamic> paymentTypes = {
    ...
    'clip': {
      ...
      'secondary': Image.asset("assets/images/clip.png", width: 55, height: 40,)
    },
    /*'online': {
      'title': 'Pago con tarjeta',
        ...
        progressIndicator: Container(
          child: Column(
            ...
            children: [
              ...
              text("¡Estamos preparando tu pedido!", isCentered: true, fontWeight: fontSemibold, fontSize: textSizeLargeMedium),
            ],
          ),
        ),
        child: Container(
                  ...
                  return Container(
                    ...
                    child: new RadioListTile(
                      ...
                      onChanged: (String value) {
                        setState(() {
                          context.read<CartProvider>().order.paymentMethod = value;
              ...
              child: Row(
                ...
                children: <Widget>[
                  Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      text("Total: \$${context.watch<CartProvider>().order.total.toStringAsFixed(0)}",
                          fontSize: textSizeLargeMedium, fontWeight: fontSemibold),
                    ],
                  ),
                  GestureDetector(
                    onTap: () {
                      ...
                      // Create order
                      Provider.of<CartProvider>(context, listen: false).createOrder(context).then((order) {
                        setState(() {
                          isLoading = false;
                        });
                        // Redirect and remove all screens
                        Navigator.pushNamedAndRemoveUntil(context, TrackingView.routeName, (route) => false, arguments: order.id);
                      });
                    },
                    child: Container(
