      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              widget.item['image'] != null ? Container(
                width: width,
              ...
              Container(
                ...
                child: text("Descripción del producto", textColor: textSecondaryColor, fontSize: textSizeSMedium),
              ),
              Container(
                width: width,
                padding: EdgeInsets.symmetric(horizontal: spacing_standard_new, vertical: spacing_standard),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    text("Precio por unidad:", fontWeight: fontSemibold, fontSize: textSizeSMedium),
                    text("\$ ${widget.item['subtotal'].toStringAsFixed(0)}"),
                    SizedBox(height: spacing_standard),
                    text("${widget.item['quantity']} Unidades", fontSize: textSizeSMedium, textColor: textSecondaryColor, fontWeight: fontSemibold),
                    SizedBox(height: spacing_standard),
                    widget.item['description'] != null ? text(widget.item['description']) : Container()
                  ],
                ),
              ),
              options.length > 0 ? Container(
                padding: EdgeInsets.symmetric(horizontal: spacing_standard_new, vertical: spacing_standard),
                child: text("Adicionales ya incluídas en el precio:", textColor: textSecondaryColor, fontSize: textSizeSMedium),
              ) : Container(),
              Container(
                width: width,
                padding: EdgeInsets.symmetric(horizontal: spacing_standard_new, vertical: spacing_standard),
