...
class _BusinessViewState extends StateMVC<BusinessView> {
  ...
  _BusinessViewState(String businessId) : super(BusinessController(businessId)) {
    _con = controller;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: LoadingOverlay(
        ...
        child: SafeArea(
          child: _con.business == null ? Container() :  NestedScrollView(
                  ...
                  title: Container(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          innerBoxScrolled == true ? text(_con.business['name'], fontWeight: fontSemibold, fontSize: textSizeNormal) : Container(),
                          IconButton(
                            icon: Icon(Icons.search, color: innerBoxScrolled == true ? textPrimaryColor : Colors.white),
                            onPressed: () {
                              showSearch(context: context, delegate: CustomSearchDelegate(business: _con.business));
                            },
                          ),
                        ],
                      ),
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background: Container(
                      ...
                      child: CachedNetworkImage(
                          imageUrl: _con.business['cover'] != null ? _con.business['cover']['url'] : 'https://firebasestorage.googleapis.com/v0/b/hermez-delivery.appspot.com/o/businesses%2Flogo.png?alt=media&token=8f1908d5-0a1d-4cd7-9e68-086a4f63fbf0',
                          height: expandHeight,
                          fit: BoxFit.cover
                      ),
                    ),
            ...
            body: Stack(
              children: [
                SingleChildScrollView(
                  padding: EdgeInsets.only(bottom: context.watch<CartProvider>().hasItems() ? 150 : 0),
                  child: Column(
                    ...
                    children: <Widget>[
                        ...
                        child: Column(
                          ...
                          children: [
                            text(_con.business['name'],
                                fontSize: textSizeLarge, fontWeight: fontBold),
                            ...
                            Row(
                              children: [
                                ...
                                text("${_con.business['delivery_time']} min",
                                    fontSize: textSizeSMedium)
                              ],
                            )
                          ],
                      ...
                      _con.sections != null ? ListView.separated(
                            primary: false,
                            shrinkWrap: true,
                            itemBuilder: (BuildContext context, int index) {
                              var section = _con.sections[index].data();
                              var items = _con.items[_con.sections[index].id];
                ...
                context.watch<CartProvider>().hasItems() ? Positioned(
                  bottom: 0,
                  right: 0,
                  left: 0,
                  child: Container(
                    ...
                    padding: EdgeInsets.symmetric(vertical: spacing_large, horizontal: spacing_standard_new),
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            text("Ver mi pedido \$${context.watch<CartProvider>().order.subtotal.toStringAsFixed(0)}", isCentered: true, textColor: Colors.white, fontSize: textSizeLargeMedium)
                          ],
                        ),
                      ),
                    ),
