                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          InkWell(
                            onTap: () {
                              launchScreen(
                                  context, AddressConfirmation.routeName);
                            },
                            child: text("Cambiar",
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                text(context
                                    ...
                                    .discountLabel()),
                                text(
                                    "-\$${context.watch<CartProvider>().couponDiscount().toStringAsFixed(0)}",
                                    textColor: food_colorAccent),
                              ],
                            ),
                          )
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        (context.watch<CartProvider>().deliveryCost() == 0.0
                            ...
                            : text(
                                "\$${context.watch<CartProvider>().deliveryCost().toStringAsFixed(0)}",
                              )),
                      ],
                    ),
                    (context.watch<CartProvider>().hasCoupon &&
