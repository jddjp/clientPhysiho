...
class SearchInputWidget extends StatefulWidget {
  ...
  SearchInputWidget({Key key, this.hintText = "Buscar negocios", this.position = 0.0, this.bgColor = appLayout_background}) : super(key: key);
          ...
          child: GestureDetector(
              ...
              children: <Widget>[
                Container(
                  ...
                  padding: EdgeInsets.only(left: 26.0, top: 12.0, bottom: 12.0, right: 50.0),
